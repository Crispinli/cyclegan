...
def build_resnet_block(inputres, dim, name="resnet"):
    with tf.variable_scope(name):
        ...
        out_res = general_conv2d(out_res, dim, 3, 3, 1, 1, 0.02, "VALID", "c1", relufactor=0.2)
...
def build_generator_resnet_9blocks(inputgen, name="generator"):
    with tf.variable_scope(name):
        ...
        o_c1 = general_conv2d(pad_input, ngf, f, f, 1, 1, 0.02, name="c1", relufactor=0.2)
        o_c2 = general_conv2d(o_c1, ngf * 2, ks, ks, 2, 2, 0.02, "SAME", "c2", relufactor=0.2)
        o_c3 = general_conv2d(o_c2, ngf * 4, ks, ks, 2, 2, 0.02, "SAME", "c3", relufactor=0.2)
        ...
        o_c4_c2 = tf.concat(axis=3, values=[o_c4, o_c2], name="o_c4_c2")
        o_c4 = general_conv2d(o_c4_c2, ngf * 2, ks, ks, 1, 1, 0.02, "SAME", "o_c4_merge")
        o_c5 = general_deconv2d(o_c4, [batch_size, 256, 256, ngf], ngf, ks, ks, 2, 2, 0.02, "SAME", "c5")
        o_c5_c1 = tf.concat(axis=3, values=[o_c5, o_c1], name="o_c5_c1")
        o_c5 = general_conv2d(o_c5_c1, ngf, ks, ks, 1, 1, 0.02, "SAME", "o_c5_merge")
        o_c6 = general_conv2d(o_c5, img_layer, f, f, 1, 1, 0.02, "SAME", "c6")
        o_c6_input = tf.concat(axis=3, values=[o_c6, inputgen], name="o_c6_input")
        o_c6 = general_conv2d(o_c6_input, img_layer, f, f, 1, 1, 0.02, "SAME", "o_c6_merge", do_relu=False)
